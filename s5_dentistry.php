        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Dentistry</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">Dentistry</h3>
                    <div class="divider my-4"></div>
                    <p>Our Department of Dentistry is committed to providing the highest quality of dental care. Our
                        team of dentists treat patients’ needs with care, skill, judgement, and comfort.</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>Complete exams, x-rays, and dental cleanings</li>
                        <li><i class="icofont-check mr-2"></i>Fillings, root canals, and extractions</li>
                        <li><i class="icofont-check mr-2"></i>Cosmetic dentistry, such as whitening, porcelain and
                            composite veneers</li>
