        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">सामान्य दवा (जनरल मेडिसिन)</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">सामान्य दवा (जनरल मेडिसिन)</h3>
                    <div class="divider my-4"></div>
                    <p>हमारा सामान्य चिकित्सा विभाग सामान्य आंतरिक चिकित्सा और इसकी उप-विशेषताओं, जैसे
                        गैस्ट्रोएंटरोलॉजी, रुमेटोलॉजी और संक्रामक रोगों को शामिल करते हुए नैदानिक सेवाओं की एक विस्तृत
                        श्रृंखला प्रदान करता है।</p>
                    <p></p>
...
<!--                    </ul>-->
            ...
            <div class="col-lg-4">
                <div class="sidebar-widget schedule-widget mt-5">
                    <img src="images/service/s3.jpeg" alt="" class="img-fluid">
                    <br><br><br>
