            ...
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    ...
                    <p>हमारा पल्मोनरी मेडिसिन विभाग फेफड़ों (फुफ्फुसीय) और सांस लेने के साथ जटिल चिकित्सा चुनौतियों वाले
                        ...
                        फुफ्फुसीय संवहनी रोगों, फुफ्फुसीय उच्च रक्तचाप, अस्थमा, स्लीप एपनिया सिंड्रोम, तीव्र और पुरानी
                        श्वसन विफलता और फेफड़ों के कैंसर में विशेषज्ञता प्रदान करते हैं।</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>राज्य के अत्याधुनिक उपकरण</li>
                        <li><i class="icofont-check mr-2"></i>ब्रोंकोस्कोपी सेवाएं</li>
                        <li><i class="icofont-check mr-2"></i>ट्रांसब्रोन्चियल फेफड़े की बायोप्सी</li>
                        <li><i class="icofont-check mr-2"></i>एलर्जी परीक्षण और इम्यूनोथेरेपी।</li>
                        <li><i class="icofont-check mr-2"></i>नींद का अध्ययन</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="sidebar-widget schedule-widget mt-5">
                    <img src="images/service/s11.jpeg" alt="" class="img-fluid">
                    <br><br><br>
