        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Physiotherapy </h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">Physiotherapy </h3>
                    <div class="divider my-4"></div>
                    <p>Our Department of Physiotherapy focuses on restoring wellness and the patients’ quality of life. Our doctors offer treatment options that aim to reduce or eliminate pain, improve mobility, recover from or prevent injuries, and improve age related issues.</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>movement tailored exercise</li>
                        <li><i class="icofont-check mr-2"></i>physical activity advice</li>
                        <li><i class="icofont-check mr-2"></i>manual therapy</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
