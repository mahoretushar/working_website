...
<section class="section service-2">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    <img src="images/facilities/f3.jpeg" alt="" class="img-fluid">
                    <div class="content">
                        <h4 class="mt-4 mb-2 title-color">आपातकालीन चिकित्सा (24/7) </h4>
                        <!--                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>-->
                        <!--                        <a href="#" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>-->
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    ...
                    <div class="content">
                        <h4 class="mt-4 mb-2 title-color">काफ़ीहाउस</h4>
                        <!--                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>-->
                        <!--                        <a href="#" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>-->
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    <img src="images/facilities/f7.jpg" alt="" class="img-fluid">
                    <div class="content">
                        <h4 class="mt-4 mb-2 title-color">आवक रोगी विभाग</h4>
                        <!--                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>-->
                        <!--                        <a href="#" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>-->
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    <img src="images/facilities/f8.jpg" alt="" class="img-fluid">
                    <div class="content">
                        <h4 class="mt-4 mb-2 title-color">जावक रोगी विभाग</h4>
                        <!--                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>-->
                        <!--                        <a href="#" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>-->
                    </div>
                </div>
