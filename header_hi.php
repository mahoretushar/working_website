                        ...
                        <div class="dropdown-content">
                            <div class="row">
                                <ul class="dropdown-menu">
                                    <div class="column">
                                        <li><a class="dropdown-item" href="s1_anaesthesiology_hi.php">एनेस्थिसियोलॉजी</a>
                                        </li>
                                        <li><a class="dropdown-item" href="s2_obstetrics_hi.php">प्रसूति & प्रसूतिशास्र</a>
                                        </li>
                                    ...
                                    <div class="column">
                                        ...
                                        <li><a class="dropdown-item" href="s7_Orthopedics_hi.php">अस्थिरोग विभाग</a></li>
                                        <li><a class="dropdown-item" href="s8_Ophthalmology_hi.php">नेत्र विज्ञान</a></li>
                                        <li><a class="dropdown-item" href="s9_Ear,%20Nose,%20Throat%20(ENT)_hi.php">कान,
                                                नाक, गला (ईएनटी)</a></li>
                                        <li><a class="dropdown-item" href="s10_Dermatology_hi.php">त्वचा विज्ञान</a></li>
