        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">भौतिक चिकित्सा</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">भौतिक चिकित्सा</h3>
                    <div class="divider my-4"></div>
                    <p>हमारा फिजियोथेरेपी विभाग स्वास्थ्य और रोगियों के जीवन की गुणवत्ता को बहाल करने पर केंद्रित है।
                        हमारे डॉक्टर उपचार के विकल्प प्रदान करते हैं जिनका उद्देश्य दर्द को कम करना या समाप्त करना,
                        गतिशीलता में सुधार करना, चोटों से उबरना या रोकना और उम्र से संबंधित मुद्दों में सुधार करना
                        है।</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>गति के अनुरूप व्यायाम</li>
                        <li><i class="icofont-check mr-2"></i>शारीरिक गतिविधि सलाह</li>
                        <li><i class="icofont-check mr-2"></i>हाथ से किया गया उपचार</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="sidebar-widget schedule-widget mt-5">
                    <img src="images/service/s14.jpeg" alt="" class="img-fluid">
                    <br><br><br>
