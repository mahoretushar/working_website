        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">दंत चिकित्सा</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">दंत चिकित्सा</h3>
                    <div class="divider my-4"></div>
                    <p>हमारा दंत चिकित्सा विभाग दंत चिकित्सा देखभाल की उच्चतम गुणवत्ता प्रदान करने के लिए प्रतिबद्ध है।
                        दंत चिकित्सकों की हमारी टीम देखभाल, कौशल, निर्णय और आराम के साथ मरीजों की जरूरतों का इलाज करती
                        है।</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>पूरी परीक्षाएं, एक्स-रे, और दांतों की सफाई</li>
                        <li><i class="icofont-check mr-2"></i>फिलिंग्स, रूट कैनाल और एक्सट्रेक्शन</li>
                        <li><i class="icofont-check mr-2"></i>कॉस्मेटिक दंत चिकित्सा, जैसे कि सफेदी, चीनी मिट्टी के बरतन
                            और मिश्रित लिबास
                        </li>
            ...
            <div class="col-lg-4">
                <div class="sidebar-widget schedule-widget mt-5">
                    <img src="images/service/s5.jpeg" alt="" class="img-fluid">
                    <br><br><br>
